...
**Answer**
There are two digit NAICs codes laying out the top level categories for various industries.
...
**Answer**
HTML code for the BLS naics codes page.
...
**Answer**
The output represents the tree structure of the page's html code.
...
**Answer**
It shows the first two levels of the nested html structure.
...
**Task** Follow the directions in the previous paragraph. Briefly describe what you see there.
**Answer**
The HTML table code that builds the table for NAICS Sectors.
...
**Answer**
A series of data frames representing all of the tables pulled from the html.
...
**Task** Follow the directions in the previous paragraph. Briefly describe what you see there.
**Answer**
A tree structure representing the list of tables pulled from the web page.
...
**Answer**
The titles of the column headers for the first table in the page (Conversion, Reference Month, Date Released).
...
**Task** Follow the directions in the previous paragraph. Briefly describe what you see there.
**Answer**
Column headers for the second table (Sector and Description).
...
**Answer**
A data frame for the NAICS codes and their Description.
...
**Answer**
A data frame representing the NAICS codes and their descriptions with the footer information removed.
...
**Answer**
A data frame representing NAICS codes  for industry sectors and their description.
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer**
Employment information for the Mining, Quarrying, and Oil and Gas Extraction sector.
...
**Task** Run the following code to read in the html. Briefly describe the output that appears below the codeblock.
**Answer**
The HTML code for the entire employment information page.
...
**Answer**
The HTML code for the Employement and Unemployment table.
...
**Answer**
A data frame representing the Employement and Unemployment table.
...
**Answer**
A data frame with the row title and total employment information for Novemeber 2021.
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer**
The employment information page for Mining, Quarrying, and Oil and Gas Extraction.
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer**
The employment information page for Construction.
...
**Answer**
The code block creates an array of 10 sector names, but does not produce an output.
...
**Answer**
The code prints the same list of 10 sectors.
...
**Answer**
The code throws an object not found error because we have not definite "sector_list."
...
**Task** Run the following code to use a for loop to print list of sectors. Briefly describe the output that appears below the codeblock.
**Answer**
We receive the same result as when the iterator was called sector instead of x.
...
**Task** Run the following code to use a for loop to print list of sectors. Briefly describe the output that appears below the codeblock.
**Answer**
Another obect not found error is thrown because sector_name is never defined.
...
**Answer**
It displays all of the data in the naics_industry data frame.
...
**Answer**
20 i.e. the number of rows in the naics_industry data frame.
...
**Answer**
This code prints a row number (starting at 1) for each row of the naics_industry data frame.
...
**Answer**
This extracts total employment for November 2021 to its own data frame.
...
**Task** Run the following code to load table from last chapter. Briefly describe the output that appears below the codeblock.
**Answer**
This generates a data frame with NAICS sector numbers and their descriptions.
...
**Answer**
The naics_industry data frame now has a sector_url column containing url's based on the url pattern identified.
...
**Answer**
The naics_industry data frame now has a column populated with the xpath selector for each industries employment table.
...
**Answer**
The data frame now has 19 rows instead of 20.
...
**Answer**
The code generates a series of data frames, each of which has a single row of data containing information about a single naics code.
...
**Answer**
A summary showing the row number, url, and xpath selector for each naics code.
...
**Answer**
A list of data frames containing the captured tables from each sector's url.
...
**Answer**
The output contains the same list of data frames, but each frame has had all unneccessary rows and columns removed.
...
**Answer**
The code produces a data frame containing the previous unemployment info along with naics codes and descriptions.
...
**Task** Run the following for loop to clean up tables. Briefly describe the output that appears below the codeblock.
**Answer**
The code removes all info from each sector's table except sector name, naics code, and November 2021 employment.
...
**Answer**
The cleaned data from each individual sector data frame is now combined into a single data frame.
...
Ta da! The end result is a nice tidy dataframe with the number of employees in November 2021 for each sector.
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer**
The employment information page for the Mining, Quarrying, and Oil and Gas Extraction sector.
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer**
The employment information for the Agriculture, Forestry, Fishing and Hunting sector, but there is no data for Nov 2021 employment, only unemployment.
...
**Answer**
The combined data frame, but the Agriculture, Forestry, Fishing and Hunting sector's value for nov_2021_employees has been changed to NA.
