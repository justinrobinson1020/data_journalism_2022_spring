...
**Answer**
The data frame shows who each state voted for, by what percentage, the percentage of businesses that received ppp loans, and the amount given per employee.
...
**Answer**
A plot of the previous data with the percentage of Trump voters on the x-axis and the percentage of businesses receiving loans on the y-axis. It appears there is a positive correlation between Trump states and PPP loans.
...
**Task** Run the following code. Describe the plot. What do you see?
**Answer**
A plot of Trump votes compared to ppp loan amount per employee. There appears to be a weaker correlation between amount per employee and Trump votes.
...
**Answer**
The calculated r values for loans received and amount per employee. The R value for loans received is more than twice the R score for amount per employee indicating a much stronger relationship.
...
**Answer**
The results of a series of statistical tests to determine if the relationship between loans received and percentage of Trump votes is statistically valid. A p value of 0.00008607 indicates a high probability of statistical significance of the two being related.
...
**Task** Run the following code. Describe the model output. What do you see?
**Answer**
The report for the relationship between amount per employee and Trump vote percentage. It shows a much weaker relationship between the variables with a p-value of .1189 and a potential negative correlation on the 95 percent confidence interval.
...
**Answer**
The average amount of loans per employee and businesses receiving loans for Clinton and Trump states. The same pattern holds true where the gap in businesses receiving loans (almost 10 points) is wider than the difference in amount received per employee (roughly $3,000).
```{r}
reveal_data %>%
  group_by(vote_2016) %>%
  summarise(
...
**Answer**
The test for average amount per employee in Clinton states vs. Trump states has a p-value of 0.2295 which indicated it could have statistical significance, but relatively weak.
...
**Task** Run the following code. Describe the output. What do you see?
**Answer**
The comparison of average number of businesses receiving loans has a much lower p-value of .002643 indicating once again that this relationship is more likely to be significant.
