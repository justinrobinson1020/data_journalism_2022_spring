...
**Answer**
The code reads in the Maryland PPP loan data, groups the data by county, counts the total number of loans for each county and creates a data frame with the top 10 counties by number of loans.
...
**Task** Run the following code. Explain what you see after running the code in the space below.
**Answer**
A bar chart showing the total loans for the top 10 counties in Maryland.
...
**Answer**
The bars are now listed in ascending order from left to right.
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer**
The bars now run horizontally on the x-axis instead of the y-axis making it possible to read the county name labels.
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer**
The graph now has a white background with gray grid lines instead of vice versa.
...
**Answer**
The background color has a pale blue color and the grid lines and fonts have also changed to fit the style used by The Economist.
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer**
There is now a descriptive title at the top of the graph with labels for each axis (it looks like they should be swapped) and an attribution caption.
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer**
A data frame showing the number of loans approved per day.
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer**
A line chart showing the number of loans approved over time.
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer**
The chart now has grid lines and labels for each month in the data set.
...
**Task** Run the following code. Explain what you see after running the code in the space below.
**Answer**
The date labels for the y-axis are now angled so they no longer overlap.
