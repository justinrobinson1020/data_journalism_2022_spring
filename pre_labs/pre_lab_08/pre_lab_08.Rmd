...
```{r echo=FALSE}
census_api_key("847bfc233d5034b7e8a7fab09e715b8cc1872dc9", install=TRUE)
```
...
**Answer**
Yes, Calvert County has a very large margin of error, but Howard County is still outside of it making the difference statistically significant.

Is the difference between Howard and everyone else significant?
**Answer**
Yes, Howard County does not overlap with any other counties.
...
**Answer**
Somerset and Caroline Counties. The change was within the margin of error for both counties.
