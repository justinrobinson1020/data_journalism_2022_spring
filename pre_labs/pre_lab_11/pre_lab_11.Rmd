...
**Answer**
The files available in the "data/hospitals" folder
...
**Answer**
Names and descriptions for the columns in the hospitals data frame. Each record has an id, name, address information, description of the hospital including type and number of bed, and geometry information.
...
**Answer**
The same information above for 10 hospitals in Maryalnd.
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
Most are General Acute care. There are also Psychiatric, Military, Chronic Disease, Long Term Care, Rehabilitation, and one Special Hospital.
```{r}
md_hospitals %>%
  group_by(TYPE) %>%
  summarise(
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
A data frame for only General Acute Care hospitals in MD.
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
A plot of hospitals in MD that roughly mirrors the shape of the state.
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
Tigris is now loaded and is masking the fips_codes function from tidycensus.
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
A data frame for every county in the country.
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
A data frame for counties in the state of Maryland.
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
A map of counties in the state of Maryland displayed on a latitude and longitude grid.
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
The location of all hospitals in Maryland plotted over the map of Maryland counties.
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
The counties now have a white background and the dots representing hospitals are now colored based on the number of beds they have.
...
**Answer**
There is no direct output. The tidycensus package is now loaded.
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
A data frame with  hospital information for General Acute Care hospitals in Maryland.
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
A data frame showing the number of hospital beds in each Maryland county.
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
A data frame with the population of each county in Maryland.
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
The same data frame, but with geometry data added for each county.
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
The data frames for county population and beds in each county.
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
The county names in the population data frame have been mutated to match the convention used in the beds by county data frame.
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
The two data frames have been joined to include population data in the beds per county data frame.
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
The na values in the data frame have been replaced with zeros.
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
A new column showing the number of beds per 100k people has been added to the data frame.
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
The map of Maryland counties is now filled with color with lighter shades of blue representing more hospital beds per 100k people.
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
The scale of color now goes from a light tan color to a dark purple making it easier to distinguish differences between counties.
...
**Answer**
The map now uses a logarithmic scale to choose colors for the number of beds per county. The area with the least number of bed per 100k is southern Maryland, and suprisingly Alleghany county has the second highest concentration of hospitals per capita after Baltimore.
