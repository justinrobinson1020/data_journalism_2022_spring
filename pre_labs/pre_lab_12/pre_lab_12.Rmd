...
**Answer**
For almost every day of vaccination there are NA and "unknown" counties. There is also a discrepancy between some counties such Garrett county having 430 days of vaccinations vs the top counties with 448.
...
**Answer**
All records where there is no county information available.
...
**Answer**
The most recent dates rank at the bottom in term of full vaccinations.
...
**Answer**
The chart shows a significant spike in vaccinations in the spring and early summer of 2021 and then a rapid decline followed by relatively flat vaccinations with occasional small peaks.
...
**Task** Run the following code and put the value of `sub` in the answer.
**Answer**
The same sentence has been added to the bar chart with autogenerated sentence added as a subtitle.
...
**Task** Run the following code and describe what the resulting chart shows
**Answer**
Most counties see a significant jump in cases starting in Jan 2022
The log char shows a more accurate trajectory for the increase in cases over time.
...
**Answer**
The number of COVID cases in each Maryland county as of 4/19/22
```{r}
ggplot() +
